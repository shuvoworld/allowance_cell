/*
 ...
 Source Schema         : allowance_management

 Target Server Type    : MySQL
 Target Server Version : 100411
 File Encoding         : 65001

 Date: 02/03/2022 16:21:01
*/
...
CREATE TABLE `beneficiaries`  (
  ...
  `father_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `mother_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `husband_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `dob` date NULL DEFAULT NULL,
  `identity_type` enum('1','2') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `identity_no` varchar(30) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  ...
  `child_info` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL,
  ...
  `status` enum('approved','rejected','pending') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
CREATE TABLE `blood_group`  (
  `id` int(11) NOT NULL,
  `blood` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
...
INSERT INTO `blood_group` VALUES (4, 'B+');
INSERT INTO `blood_group` VALUES (5, 'AB-');
INSERT INTO `blood_group` VALUES (6, 'AB+');
INSERT INTO `blood_group` VALUES (7, 'O-');
INSERT INTO `blood_group` VALUES (8, 'O+');
...
CREATE TABLE `departments`  (
  ...
  `ministry_id` int(10) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 485 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of departments
-- ----------------------------
INSERT INTO `departments` VALUES (1, NULL, 'জন বিভাগ', '1', 1);
INSERT INTO `departments` VALUES (2, NULL, 'আপন বিভাগ', '1', 1);
INSERT INTO `departments` VALUES (3, NULL, 'প্রধানমন্ত্রীর কার্যালয়', '2', 2);
INSERT INTO `departments` VALUES (4, NULL, 'গভর্ন্যান্স ইনোভেশন ইউনিট', '2', 2);
INSERT INTO `departments` VALUES (5, NULL, 'স্পেশাল সিকিউরিটি ফোর্স', '2', 2);
INSERT INTO `departments` VALUES (6, NULL, 'বাংলাদেশ অর্থনৈতিক অঞ্চল কর্তৃপক্ষ', '2', 2);
INSERT INTO `departments` VALUES (7, NULL, 'বাংলাদেশ রপ্তানী প্রক্রিয়াকরণ কর্তৃপক্ষ (বেপজা)', '2', 2);
INSERT INTO `departments` VALUES (8, NULL, 'পাবলিক প্রাইভেট পার্টনারশীপ অফিস', '2', 2);
INSERT INTO `departments` VALUES (9, NULL, 'এনজিও বিষয়ক ব্যুরো', '2', 2);
INSERT INTO `departments` VALUES (10, NULL, 'আশ্রয়ণ-২ প্রকল্প, প্রধানমন্ত্রীর কার্যালয়', '2', 2);
INSERT INTO `departments` VALUES (11, NULL, 'জাতীয় দক্ষতা উন্নয়ন কর্তৃপক্ষ', '2', 2);
INSERT INTO `departments` VALUES (12, NULL, 'বাংলাদেশ বিনিয়োগ বোর্ড', '2', 2);
INSERT INTO `departments` VALUES (13, NULL, 'সশস্ত্র বাহিনী বিভাগ', '5', 5);
INSERT INTO `departments` VALUES (14, NULL, 'বাংলাদেশ নৌ বাহিনী', '5', 5);
INSERT INTO `departments` VALUES (15, NULL, 'বাংলাদেশ সেনা বাহিনী', '5', 5);
INSERT INTO `departments` VALUES (16, NULL, 'বাংলাদেশ বিমান বাহিনী', '5', 5);
INSERT INTO `departments` VALUES (17, NULL, 'মন্ত্রিপরিষদ বিভাগ', '3', 3);
INSERT INTO `departments` VALUES (18, NULL, 'শিক্ষা মন্ত্রণালয়', '18', 18);
INSERT INTO `departments` VALUES (19, NULL, 'মাধ্যমিক ও উচ্চ শিক্ষা বিভাগ', '31', 31);
INSERT INTO `departments` VALUES (20, NULL, 'বাংলাদেশ স্কাউটস', '31', 31);
INSERT INTO `departments` VALUES (21, NULL, 'প্রধানমন্ত্রীর শিক্ষা সহায়তা ট্রাস্ট', '31', 31);
INSERT INTO `departments` VALUES (22, NULL, 'মাধ্যমিক ও উচ্চ মাধ্যমিক শিক্ষা বোর্ড, বাংলাদেশ', '31', 31);
INSERT INTO `departments` VALUES (23, NULL, 'মাধ্যমিক ও উচ্চ মাধ্যমিক শিক্ষা বোর্ড, কুমিল্লা', '31', 31);
INSERT INTO `departments` VALUES (24, NULL, 'মাধ্যমিক ও উচ্চমাধ্যমিক শিক্ষা বোর্ড, দিনাজপুর', '31', 31);
INSERT INTO `departments` VALUES (25, NULL, 'মাধ্যমিক ও উচ্চ মাধ্যমিক শিক্ষা বোর্ড, রাজশাহী', '31', 31);
INSERT INTO `departments` VALUES (26, NULL, 'মাধ্যমিক ও উচ্চ মাধ্যমিক শিক্ষা বোর্ড, বরিশাল', '31', 31);
INSERT INTO `departments` VALUES (27, NULL, 'বাংলাদেশ ন্যাশনাল কমিশন ফর ইউনেস্কো', '31', 31);
INSERT INTO `departments` VALUES (28, NULL, 'মাধ্যমিক ও উচ্চমাধ্যমিক শিক্ষাবোর্ড, চট্টগ্রাম', '31', 31);
INSERT INTO `departments` VALUES (29, NULL, 'মাধ্যমিক ও উচ্চমাধ্যমিক শিক্ষাবোর্ড, সিলেট', '31', 31);
INSERT INTO `departments` VALUES (30, NULL, 'বেসরকারী শিক্ষা প্রতিষ্ঠান শিক্ষক ও কর্মচারী অবসর সুবিধা বোর্ড', '31', 31);
INSERT INTO `departments` VALUES (31, NULL, 'বাংলাদেশ শিক্ষা তথ্য ও পরিসংখ্যান ব্যুরো (ব্যানবেইস)', '31', 31);
INSERT INTO `departments` VALUES (32, NULL, 'উচ্চশিক্ষা মানোন্নয়ন প্রকল্প', '31', 31);
INSERT INTO `departments` VALUES (33, NULL, 'মাধ্যমিক ও উচ্চশিক্ষা অধিদপ্তর', '31', 31);
INSERT INTO `departments` VALUES (34, NULL, 'জাতীয় পাঠ্যক্রম ও পাঠ্যপুস্তক বোর্ড', '31', 31);
INSERT INTO `departments` VALUES (35, NULL, 'বিশ্ববিদ্যালয় মঞ্জুরী কমিশন', '31', 31);
INSERT INTO `departments` VALUES (36, NULL, 'জাতীয় শিক্ষা ব্যবস্থাপনা একাডেমি', '31', 31);
INSERT INTO `departments` VALUES (37, NULL, 'মাধ্যমিক ও উচ্চমাধ্যমিক শিক্ষাবোর্ড, ঢাকা', '31', 31);
INSERT INTO `departments` VALUES (38, NULL, 'পরিদর্শন ও নিরীক্ষা অধিদপ্তর', '31', 31);
INSERT INTO `departments` VALUES (39, NULL, 'শিক্ষা প্রকৌশল অধিদপ্তর', '31', 31);
INSERT INTO `departments` VALUES (40, NULL, 'বেসরকারী শিক্ষক নিবন্ধন ও সনদ কর্তৃপক্ষ', '31', 31);
INSERT INTO `departments` VALUES (41, NULL, 'কারিগরি ও মাদ্‌রাসা শিক্ষা বিভাগ', '48', 48);
INSERT INTO `departments` VALUES (42, NULL, 'কারিগরী শিক্ষা অধিদপ্তর', '48', 48);
INSERT INTO `departments` VALUES (43, NULL, 'মাদরাসা শিক্ষা অধিদপ্তর', '48', 48);
INSERT INTO `departments` VALUES (44, NULL, 'বাংলাদেশ কারিগরি শিক্ষা বোর্ড', '48', 48);
INSERT INTO `departments` VALUES (45, NULL, 'বাংলাদেশ মাদরাসা শিক্ষা বোর্ড', '48', 48);
INSERT INTO `departments` VALUES (46, NULL, 'জাতীয় কম্পিউটার প্রশিক্ষণ ও গবেষণা একাডেমি', '48', 48);
INSERT INTO `departments` VALUES (47, NULL, 'বাংলাদেশ মাদরাসা শিক্ষক প্রশিক্ষণ ইনস্টিটিউট', '48', 48);
INSERT INTO `departments` VALUES (48, NULL, 'গৃহায়ণ ও গণপূর্ত মন্ত্রণালয়', '50', 50);
INSERT INTO `departments` VALUES (49, NULL, 'গণপূর্ত অধিদপ্তর', '50', 50);
INSERT INTO `departments` VALUES (50, NULL, 'স্থাপত্য অধিদপ্তর', '50', 50);
INSERT INTO `departments` VALUES (51, NULL, 'নগর উন্নয়ন অধিদপ্তর', '50', 50);
INSERT INTO `departments` VALUES (52, NULL, 'অভ্যন্তরীণ নিরীক্ষা পরিদপ্তর', '50', 50);
INSERT INTO `departments` VALUES (53, NULL, 'কক্সবাজার উন্নয়ন কতৃপক্ষ', '50', 50);
INSERT INTO `departments` VALUES (54, NULL, 'জাতীয় গৃহায়ন কর্তৃপক্ষ', '50', 50);
INSERT INTO `departments` VALUES (55, NULL, 'রাজধানী উন্নয়ন কর্তৃপক্ষ (রাজউক)', '50', 50);
INSERT INTO `departments` VALUES (56, NULL, 'চট্টগ্রাম উন্নয়ন কর্তৃপক্ষ', '50', 50);
INSERT INTO `departments` VALUES (57, NULL, 'রাজশাহী উন্নয়ন কর্তৃপক্ষ', '50', 50);
INSERT INTO `departments` VALUES (58, NULL, 'খুলনা উন্নয়ন কর্তৃপক্ষ', '50', 50);
INSERT INTO `departments` VALUES (59, NULL, 'হাউজিং এন্ড বিল্ডিং রিসার্চ ইনষ্টিটিউট', '50', 50);
INSERT INTO `departments` VALUES (60, NULL, 'সরকারি আবাসন পরিদপ্তর', '50', 50);
INSERT INTO `departments` VALUES (61, NULL, 'বাংলাদেশ জাতীয় সংসদ', '61', 61);
INSERT INTO `departments` VALUES (62, NULL, 'জনপ্রশাসন মন্ত্রণালয়', '4', 4);
INSERT INTO `departments` VALUES (63, NULL, 'বাংলাদেশ সরকারি কর্ম কমিশন সচিবালয়', '4', 4);
INSERT INTO `departments` VALUES (64, NULL, 'বাংলাদেশ সিভিল সার্ভিস প্রশাসন একাডেমি', '4', 4);
INSERT INTO `departments` VALUES (65, NULL, 'বাংলাদেশ লোক প্রশাসন প্রশিক্ষণ কেন্দ্র (বিপিএটিসি)', '4', 4);
INSERT INTO `departments` VALUES (66, NULL, 'বাংলাদেশ কর্মচারি কল্যাণ বোর্ড (বিকেকেবি)', '4', 4);
INSERT INTO `departments` VALUES (67, NULL, 'মুদ্রণ ও প্রকাশনা অধিদপ্তর', '4', 4);
INSERT INTO `departments` VALUES (68, NULL, 'সরকারী যানবাহন অধিদপ্তর', '4', 4);
INSERT INTO `departments` VALUES (69, NULL, 'সরকারি কর্মচারী হাসপাতাল', '4', 4);
INSERT INTO `departments` VALUES (70, NULL, 'বিয়াম ফাউন্ডেশন', '4', 4);
INSERT INTO `departments` VALUES (71, NULL, 'ভূমি মন্ত্রণালয়', '25', 25);
INSERT INTO `departments` VALUES (72, NULL, 'ভূমি প্রশাসন প্রশিক্ষণ কেন্দ্র', '25', 25);
INSERT INTO `departments` VALUES (73, NULL, 'ভূমি রেকর্ড ও জরিপ অধিদপ্তর', '25', 25);
INSERT INTO `departments` VALUES (74, NULL, 'ভূমি আপীল বোর্ড', '25', 25);
INSERT INTO `departments` VALUES (75, NULL, 'ভূমি সংস্কার বোর্ড', '25', 25);
INSERT INTO `departments` VALUES (76, NULL, 'পার্বত্য চট্টগ্রাম বিষয়ক মন্ত্রণালয়', '23', 23);
INSERT INTO `departments` VALUES (77, NULL, 'পার্বত্য চট্টগ্রাম উন্নয়ন বোর্ড', '23', 23);
INSERT INTO `departments` VALUES (78, NULL, 'পার্বত্য চট্টগ্রাম আঞ্চলিক পরিষদ', '23', 23);
INSERT INTO `departments` VALUES (79, NULL, 'বান্দরবন পার্বত্য জেলা পরিষদ', '23', 23);
INSERT INTO `departments` VALUES (80, NULL, 'রাঙ্গামাটি পার্বত্য জেলা পরিষদ', '23', 23);
INSERT INTO `departments` VALUES (81, NULL, 'উপজাতীয় শরণার্থী বিষয়ক টাস্কফোর্স', '23', 23);
INSERT INTO `departments` VALUES (82, NULL, 'খাগড়াছড়ি পার্বত্য জেলা পরিষদ', '23', 23);
INSERT INTO `departments` VALUES (83, NULL, 'বেসামরিক বিমান পরিবহন ও পর্যটন মন্ত্রণালয়', '24', 24);
INSERT INTO `departments` VALUES (84, NULL, 'বাংলাদেশ ট্যুরিজম বোর্ড', '24', 24);
INSERT INTO `departments` VALUES (85, NULL, 'বাংলাদেশ বেসামরিক বিমান চলাচল কর্তৃপক্ষ', '24', 24);
INSERT INTO `departments` VALUES (86, NULL, 'বাংলাদেশ পর্যটন করপোরেশন', '24', 24);
INSERT INTO `departments` VALUES (87, NULL, 'বাংলাদেশ বিমান', '24', 24);
INSERT INTO `departments` VALUES (88, NULL, 'হোটেলস্ ইন্টারন্যাশনাল লিমিটেড', '24', 24);
INSERT INTO `departments` VALUES (89, NULL, 'বাংলাদেশ সার্ভিসেস লিমিটেড', '24', 24);
INSERT INTO `departments` VALUES (90, NULL, 'আইন, বিচার ও সংসদ বিষয়ক মন্ত্রণালয়', '7', 7);
INSERT INTO `departments` VALUES (91, NULL, 'আইন ও বিচার বিভাগ', '7', 7);
INSERT INTO `departments` VALUES (92, NULL, 'বাংলাদেশ জুডিসিয়াল সার্ভিস কমিশন', '7', 7);
INSERT INTO `departments` VALUES (93, NULL, 'জাতীয় আইনগত সহায়তা প্রদান সংস্থা', '7', 7);
INSERT INTO `departments` VALUES (94, NULL, 'নিবন্ধন পরিদপ্তর', '7', 7);
INSERT INTO `departments` VALUES (95, NULL, 'এটর্নি জেনারেলের অফিস', '7', 7);
INSERT INTO `departments` VALUES (96, NULL, 'লেজিসলেটিভ ও সংসদ বিষয়ক বিভাগ', '7', 7);
INSERT INTO `departments` VALUES (97, NULL, 'আইন কমিশন-বাংলাদেশ', '7', 7);
INSERT INTO `departments` VALUES (98, NULL, 'জাতীয় মানবাধিকার কমিশন বাংলাদেশ', '7', 7);
INSERT INTO `departments` VALUES (99, NULL, 'সমাজকল্যাণ মন্ত্রণালয়', '35', 35);
INSERT INTO `departments` VALUES (100, NULL, 'জাতীয় সমাজসেবা একাডেমি', '35', 35);
INSERT INTO `departments` VALUES (101, NULL, 'জাতীয় প্রতিবন্ধী উন্নয়ন ফাউন্ডেশন', '35', 35);
INSERT INTO `departments` VALUES (102, NULL, 'সমাজসেবা অধিদফতর', '35', 35);
INSERT INTO `departments` VALUES (103, NULL, 'বাংলাদেশ জাতীয় সমাজকল্যাণ পরিষদ', '35', 35);
INSERT INTO `departments` VALUES (104, NULL, 'কৃষি মন্ত্রণালয়', '8', 8);
INSERT INTO `departments` VALUES (105, NULL, 'বীজ প্রত্যয়ন এজেন্সী', '8', 8);
INSERT INTO `departments` VALUES (106, NULL, 'জাতীয় কৃষি প্রশিক্ষণ একাডেমি (নাটা)', '8', 8);
INSERT INTO `departments` VALUES (107, NULL, 'হর্টেক্স ফাউন্ডেশন', '8', 8);
INSERT INTO `departments` VALUES (108, NULL, 'বাংলাদেশ কৃষি গবেষণা কাউন্সিল', '8', 8);
INSERT INTO `departments` VALUES (109, NULL, 'বাংলাদেশ কৃষি উন্নয়ন কর্পোরেশন (বিএডিসি)', '8', 8);
INSERT INTO `departments` VALUES (110, NULL, 'কৃষি সম্প্রসারণ অধিদপ্তর', '8', 8);
INSERT INTO `departments` VALUES (111, NULL, 'বাংলাদেশ ধান গবেষণা ইনস্টিটিউট', '8', 8);
INSERT INTO `departments` VALUES (112, NULL, 'বাংলাদেশ কৃষি গবেষণা ইনস্টিটিউট', '8', 8);
INSERT INTO `departments` VALUES (113, NULL, 'বাংলাদেশ পাট গবেষণা ইনস্টিটিউট (বিজেআরআই)', '8', 8);
INSERT INTO `departments` VALUES (114, NULL, 'বাংলাদেশ পরমাণু কৃষি গবেষণা ইনস্টিটিউট', '8', 8);
INSERT INTO `departments` VALUES (115, NULL, 'বাংলাদেশ সুগারক্রপ গবেষণা ইনস্টিটিউট', '8', 8);
INSERT INTO `departments` VALUES (116, NULL, 'বরেন্দ্র বহুমুখী উন্নয়ন কর্তৃপক্ষ', '8', 8);
INSERT INTO `departments` VALUES (117, NULL, 'তুলা উন্নয়ন বোর্ড', '8', 8);
INSERT INTO `departments` VALUES (118, NULL, 'মৃত্তিকা সম্পদ উন্নয়ন ইনস্টিটিউট', '8', 8);
INSERT INTO `departments` VALUES (119, NULL, 'কৃষি বিপণন অধিদপ্তর', '8', 8);
INSERT INTO `departments` VALUES (120, NULL, 'কৃষি তথ্য সার্ভিস (এআইএস)', '8', 8);
INSERT INTO `departments` VALUES (121, NULL, 'বাংলাদেশ ফলিত পুষ্টি ও মানব সম্পদ উন্নয়ন বোর্ড', '8', 8);
INSERT INTO `departments` VALUES (123, NULL, 'স্বাস্থ্য সেবা বিভাগ', '51', 51);
INSERT INTO `departments` VALUES (124, NULL, 'স্বাস্থ্য অধিদপ্তর', '51', 51);
INSERT INTO `departments` VALUES (125, NULL, 'স্বাস্থ্য প্রকৌশল অধিদপ্তর', '51', 51);
INSERT INTO `departments` VALUES (126, NULL, 'নার্সিং ও মিডওয়াইফারি অধিদপ্তর', '51', 51);
INSERT INTO `departments` VALUES (127, NULL, 'ঔষধ প্রশাসন অধিদপ্তর', '51', 51);
INSERT INTO `departments` VALUES (128, NULL, 'আন্তর্জাতিক উদরাময় রোগ গবেষণা কেন্দ্র, বাংলাদেশ', '51', 51);
INSERT INTO `departments` VALUES (129, NULL, 'স্বাস্থ্য অর্থনীতি ইউনিট', '51', 51);
INSERT INTO `departments` VALUES (130, NULL, 'বাংলাদেশ ফার্মেসী কাউন্সিল', '51', 51);
INSERT INTO `departments` VALUES (131, NULL, 'ট্রান্সপোর্ট এন্ড ইকুইপমেন্ট মেইনটেনেন্স অর্গানাইজেশন (টেমো)', '51', 51);
INSERT INTO `departments` VALUES (132, NULL, 'বাংলাদেশ নার্সিং এন্ড মিডওয়াইফারি কাউন্সিল', '51', 51);
INSERT INTO `departments` VALUES (133, NULL, 'স্বাস্থ্য শিক্ষা ও পরিবার কল্যাণ বিভাগ', '52', 52);
INSERT INTO `departments` VALUES (134, NULL, 'বঙ্গবন্ধু শেখ মুজিব মেডিকেল বিশ্ববিদ্যালয়', '52', 52);
INSERT INTO `departments` VALUES (135, NULL, 'ঢাকা মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (136, NULL, 'স্যার সলিমুল্লাহ মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (137, NULL, 'ময়মনসিংহ মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (138, NULL, 'শের-ই-বাংলা মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (139, NULL, 'চট্টগ্রাম মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (140, NULL, 'শহীদ সোহরাওয়ার্দী মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (141, NULL, 'সিলেট এম.এ.জি ওসমানী মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (142, NULL, 'রাজশাহী মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (143, NULL, 'রংপুর মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (144, NULL, 'খুলনা মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (145, NULL, 'শহীদ জিয়াউর রহমান মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (146, NULL, 'এম আব্দুর রহিম মেডিকেল কলেজ, দিনাজপুর', '52', 52);
INSERT INTO `departments` VALUES (147, NULL, 'কুমিল্লা মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (148, NULL, 'কক্সবাজার মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (149, NULL, 'পাবনা মেডিকেল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (150, NULL, 'ঢাকা ডেন্টাল কলেজ', '52', 52);
INSERT INTO `departments` VALUES (151, NULL, 'পরিবার পরিকল্পনা অধিদপ্তর', '52', 52);
INSERT INTO `departments` VALUES (152, NULL, 'জাতীয় জনসংখ্যা গবেষণা ও প্রশিক্ষণ ইনস্টিটিউট (নিপোর্ট)', '52', 52);
INSERT INTO `departments` VALUES (153, NULL, 'পররাষ্ট্র মন্ত্রণালয়', '15', 15);
INSERT INTO `departments` VALUES (154, NULL, 'বাংলাদেশ দূতাবাস, রিয়াদ, সৌদি আরব', '15', 15);
INSERT INTO `departments` VALUES (155, NULL, 'বাংলাদেশ কনস্যুলেট, জেদ্দা, সৌদি আরব', '15', 15);
INSERT INTO `departments` VALUES (156, NULL, 'বাংলাদেশ হাই কমিশন, সিঙ্গাপুর', '15', 15);
INSERT INTO `departments` VALUES (157, NULL, 'বাংলাদেশ দূতাবাস, স্টকহোম, সুইডেন', '15', 15);
INSERT INTO `departments` VALUES (158, NULL, 'বাংলাদেশ হাই কমিশন, লন্ডন, যুক্তরাজ্য', '15', 15);
INSERT INTO `departments` VALUES (159, NULL, 'বাংলাদেশ দূতাবাস, ওয়াশিংটন ডিসি, ইউএসএ', '15', 15);
INSERT INTO `departments` VALUES (160, NULL, 'জাতিসংঘের বাংলাদেশ স্থায়ী মিশন', '15', 15);
INSERT INTO `departments` VALUES (161, NULL, 'বাংলাদেশ কনস্যুলেট জেনারেল, নিউ ইয়র্ক, ইউএসএ', '15', 15);
INSERT INTO `departments` VALUES (162, NULL, 'বাংলাদেশ কনসুলেট জেনারেল, লস এঞ্জেলস, ইউএসএ', '15', 15);
INSERT INTO `departments` VALUES (163, NULL, 'বাংলাদেশ দূতাবাস, বেইজিং, চীন', '15', 15);
INSERT INTO `departments` VALUES (164, NULL, 'বাংলাদেশ ডেপুটি হাই কমিশন, করাচী, পাকিস্তান', '15', 15);
INSERT INTO `departments` VALUES (165, NULL, 'বাংলাদেশ হাই কমিশন, কেনিয়া', '15', 15);
INSERT INTO `departments` VALUES (166, NULL, 'বাংলাদেশ ইনস্টিটিউট অব ইন্টারন্যাশনাল এন্ড ইস্ট্রাটেজিক স্টাডিজ', '15', 15);
INSERT INTO `departments` VALUES (167, NULL, 'আমেরিকান ইনস্টিটিউট অব বাংলাদেশ স্টাডিজ', '15', 15);
INSERT INTO `departments` VALUES (168, NULL, 'বাংলাদেশ ইনস্টিটিউট অব ল এন্ড ইন্টারন্যাশনাল এফেয়ারস', '15', 15);
INSERT INTO `departments` VALUES (169, NULL, 'বাংলাদেশ দূতাবাস, আম্মান, জর্ডান', '15', 15);
INSERT INTO `departments` VALUES (170, NULL, 'বাংলাদেশ ডেপুটি হাই কমিশন, কোলকাতা, ভারত', '15', 15);
INSERT INTO `departments` VALUES (171, NULL, 'বাংলাদেশ দূতাবাস, প্যারিস, ফ্রান্স', '15', 15);
INSERT INTO `departments` VALUES (172, NULL, 'বাংলাদেশ দূতাবাস, বাহরাইন', '15', 15);
INSERT INTO `departments` VALUES (173, NULL, 'বাংলাদেশ হাই কমিশন, ক্যানবেরা, অস্ট্রেলিয়া', '15', 15);
INSERT INTO `departments` VALUES (174, NULL, 'বাংলাদেশ হাই কমিশন, বন্দর সেরি বেগাওয়ান, ব্রুনেই দারুস সালাম', '15', 15);
INSERT INTO `departments` VALUES (175, NULL, 'বাংলাদেশ দূতাবাস, ব্রাসেলস, বেলজিয়াম', '15', 15);
INSERT INTO `departments` VALUES (176, NULL, 'বাংলাদেশ হাই কমিশন, অটোয়া, কানাডা', '15', 15);
INSERT INTO `departments` VALUES (177, NULL, 'বাংলাদেশ দূতাবাস, বার্লিন, জার্মানী', '15', 15);
INSERT INTO `departments` VALUES (178, NULL, 'বাংলাদেশ হাই কমিশন, নয়াদিল্লী, ভারত', '15', 15);
INSERT INTO `departments` VALUES (179, NULL, 'বাংলাদেশ দূতাবাস, রোম, ইতালী', '15', 15);
INSERT INTO `departments` VALUES (180, NULL, 'বাংলাদেশ দূতাবাস, টোকিও, জাপান', '15', 15);
INSERT INTO `departments` VALUES (181, NULL, 'বাংলাদেশ হাই কমিশন, কুয়ালালামপুর, মালয়েশিয়া', '15', 15);
INSERT INTO `departments` VALUES (182, NULL, 'বাংলাদেশ দূতাবাস, মস্কো, রাশিয়া ফেডারেশন', '15', 15);
INSERT INTO `departments` VALUES (183, NULL, 'বাংলাদেশ দূতাবাস, হেগ, নেদারল্যান্ড', '15', 15);
INSERT INTO `departments` VALUES (184, NULL, 'বাংলাদেশ হাই কমিশন, ইসলামাবাদ, পাকিস্তান', '15', 15);
INSERT INTO `departments` VALUES (185, NULL, 'মহিলা ও শিশু বিষয়ক মন্ত্রণালয়', '26', 26);
INSERT INTO `departments` VALUES (186, NULL, 'মহিলা বিষয়ক অধিদপ্তর', '26', 26);
INSERT INTO `departments` VALUES (187, NULL, 'জাতীয় মহিলা সংস্থা', '26', 26);
INSERT INTO `departments` VALUES (188, NULL, 'বাংলাদেশ শিশু একাডেমি', '26', 26);
INSERT INTO `departments` VALUES (189, NULL, 'জয়িতা ফাউন্ডেশন', '26', 26);
INSERT INTO `departments` VALUES (190, NULL, 'বস্ত্র ও পাট মন্ত্রণালয়', '19', 19);
INSERT INTO `departments` VALUES (191, NULL, 'বাংলাদেশ জুট কর্পোরেশন', '19', 19);
INSERT INTO `departments` VALUES (192, NULL, 'বস্ত্র পরিদপ্তর', '19', 19);
INSERT INTO `departments` VALUES (193, NULL, 'বাংলাদেশ পাটকল করপোরেশন', '19', 19);
INSERT INTO `departments` VALUES (194, NULL, 'বস্ত্র অধিদপ্তর', '19', 19);
INSERT INTO `departments` VALUES (195, NULL, 'বাংলাদেশ তাঁত বোর্ড', '19', 19);
INSERT INTO `departments` VALUES (196, NULL, 'বাংলাদেশ বস্ত্র কারখানা কর্পোরেশন', '19', 19);
INSERT INTO `departments` VALUES (197, NULL, 'বাংলাদেশ রেশম গবেষণা ও প্রশিক্ষণ ইনস্টিটিউট', '19', 19);
INSERT INTO `departments` VALUES (198, NULL, 'বাংলাদেশ রেশম উন্নয়ন বোর্ড', '19', 19);
INSERT INTO `departments` VALUES (199, NULL, 'পাট অধিদপ্তর', '19', 19);
INSERT INTO `departments` VALUES (201, NULL, 'বিদ্যুৎ বিভাগ', '22', 22);
INSERT INTO `departments` VALUES (202, NULL, 'টেকসই ও নবায়নযোগ্য জ্বালানি উন্নয়ন কর্তৃপক্ষ (এসআরইডিএ)', '22', 22);
INSERT INTO `departments` VALUES (203, NULL, 'ডেসকো', '22', 22);
INSERT INTO `departments` VALUES (204, NULL, 'ঢাকা বিদ্যুৎ বিতরণ কোম্পানি লিমিটেড', '22', 22);
INSERT INTO `departments` VALUES (205, NULL, 'আশুগঞ্জ পাওয়ার স্টেশন কোম্পানী লি.', '22', 22);
INSERT INTO `departments` VALUES (206, NULL, 'ইলেক্ট্রিসিটি জেনারেশন কোম্পানি অব বাংলাদেশ লিঃ', '22', 22);
INSERT INTO `departments` VALUES (207, NULL, 'ওয়েষ্ট জোন পাওয়ার ডিস্ট্রিবিউশন কোম্পানি লি.', '22', 22);
INSERT INTO `departments` VALUES (208, NULL, 'বাংলাদেশ পল্লী বিদ্যুতায়ন বোর্ড', '22', 22);
INSERT INTO `departments` VALUES (209, NULL, 'রুরাল পাওয়ার কোম্পানী লিমিটেড', '22', 22);
INSERT INTO `departments` VALUES (210, NULL, 'পাওয়ার সেল', '22', 22);
INSERT INTO `departments` VALUES (211, NULL, 'পাওয়ার গ্রিড কোম্পানি অব বাংলাদেশ লিঃ', '22', 22);
INSERT INTO `departments` VALUES (212, NULL, 'বাংলাদেশ বিদ্যুৎ উন্নয়ন বোর্ড', '22', 22);
INSERT INTO `departments` VALUES (213, NULL, 'বাংলাদেশ জ্বালানি ও বিদ্যুৎ গবেষণা কাউন্সিল (ইপিআরসি)', '22', 22);
INSERT INTO `departments` VALUES (214, NULL, 'কোল পাওয়ার জেনারেশন কোম্পানী বাংলাদেশ লিমিটেড (সিপিজিসিবিএল)', '22', 22);
INSERT INTO `departments` VALUES (215, NULL, 'জ্বালানি ও খনিজ সম্পদ বিভাগ', '22', 22);
INSERT INTO `departments` VALUES (216, NULL, 'বাংলাদেশ পেট্রোলিয়াম কর্পোরেশন', '22', 22);
INSERT INTO `departments` VALUES (217, NULL, 'বাখরাবাদ গ্যাস ডিস্ট্রিবিউশন কোম্পানী লিমিটেড', '22', 22);
INSERT INTO `departments` VALUES (218, NULL, 'সিলেট গ্যাস ফিল্ডস লিমিটেড', '22', 22);
INSERT INTO `departments` VALUES (219, NULL, 'খনিজ সম্পদ উন্নয়ন ব্যুরো', '22', 22);
INSERT INTO `departments` VALUES (220, NULL, 'বাংলাদেশ পেট্রোলিয়াম এক্সপ্লোরেশন এন্ড প্রোডাকশন কোম্পানী লিঃ', '22', 22);
INSERT INTO `departments` VALUES (221, NULL, 'তিতাস গ্যাস ট্রান্সমিশন এন্ড ডিস্ট্রিবিউশন কোম্পানি', '22', 22);
INSERT INTO `departments` VALUES (222, NULL, 'বাংলাদেশ এনার্জি রেগুলেটরি কমিশন', '22', 22);
INSERT INTO `departments` VALUES (223, NULL, 'বাংলাদেশ তৈল, গ্যাস ও খনিজ কর্পোরেশন', '22', 22);
INSERT INTO `departments` VALUES (224, NULL, 'বাংলাদেশ পেট্রোলিয়াম ইন্সটিটিউট', '22', 22);
INSERT INTO `departments` VALUES (225, NULL, 'বাংলাদেশ ভূতাত্ত্বিক জরিপ অধিদপ্তর', '22', 22);
INSERT INTO `departments` VALUES (226, NULL, 'বাংলাদেশ হাইড্রোকার্বন ইউনিট', '22', 22);
INSERT INTO `departments` VALUES (227, NULL, 'রূপান্তরিত প্রাকৃতিক গ্যাস কোম্পানি লিমিটেড', '22', 22);
INSERT INTO `departments` VALUES (228, NULL, 'বিস্ফোরক অধিদপ্তর', '22', 22);
INSERT INTO `departments` VALUES (229, NULL, 'কর্ণফুলী গ্যাস ডিস্ট্রিবিউশন কোস্পানী লিমিটেড', '22', 22);
INSERT INTO `departments` VALUES (230, NULL, 'পরিকল্পনা মন্ত্রণালয়', '55', 55);
INSERT INTO `departments` VALUES (231, NULL, 'পরিকল্পনা বিভাগ', '55', 55);
INSERT INTO `departments` VALUES (232, NULL, 'বাংলাদেশ উন্নয়ন গবেষণা প্রতিষ্ঠান', '55', 55);
INSERT INTO `departments` VALUES (233, NULL, 'জাতীয় পরিকল্পনা ও উন্নয়ন একাডেমি (এনএপিডি)', '55', 55);
INSERT INTO `departments` VALUES (234, NULL, 'পরিসংখ্যান ও তথ্য ব্যবস্থাপনা বিভাগ', '6', 57);
INSERT INTO `departments` VALUES (235, NULL, 'বাংলাদেশ পরিসংখ্যান ব্যুরো', '57', 57);
INSERT INTO `departments` VALUES (236, NULL, 'বাস্তবায়ন পরিবীক্ষণ ও মূল্যায়ন বিভাগ', '57', 57);
INSERT INTO `departments` VALUES (237, NULL, 'স্থানীয় সরকার, পল্লী উন্নয়ন ও সমবায় মন্ত্রণালয়', '237', 237);
INSERT INTO `departments` VALUES (238, NULL, 'স্থানীয় সরকার বিভাগ', '58', 58);
INSERT INTO `departments` VALUES (239, NULL, 'স্থানীয় সরকার প্রকৌশল অধিদপ্তর', '58', 58);
INSERT INTO `departments` VALUES (240, NULL, 'খুলনা সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (241, NULL, 'চট্টগ্রাম ওয়াসা', '58', 58);
INSERT INTO `departments` VALUES (242, NULL, 'চট্টগ্রাম সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (243, NULL, 'জনস্বাস্থ্য প্রকৌশল অধিদপ্তর', '58', 58);
INSERT INTO `departments` VALUES (244, NULL, 'জাতীয় স্থানীয় সরকার ইনস্টিটিউট', '58', 58);
INSERT INTO `departments` VALUES (245, NULL, 'ঢাকা উত্তর সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (246, NULL, 'ঢাকা ওয়াসা', '58', 58);
INSERT INTO `departments` VALUES (247, NULL, 'ঢাকা দক্ষিণ সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (248, NULL, 'নারায়ণগঞ্জ সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (249, NULL, 'পানি সরবরাহ ও পয়:নিষ্কাশন কর্তৃপক্ষ', '58', 58);
INSERT INTO `departments` VALUES (250, NULL, 'সিলেট সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (251, NULL, 'রাজশাহী সিটি কর্পোরেশন', '58', 58);
INSERT INTO `departments` VALUES (252, NULL, 'খুলনা ওয়াসা', '58', 58);
INSERT INTO `departments` VALUES (253, NULL, 'পল্লী উন্নয়ন ও সমবায় বিভাগ', '59', 59);
INSERT INTO `departments` VALUES (254, NULL, 'সমবায় অধিদপ্তর', '59', 59);
INSERT INTO `departments` VALUES (255, NULL, 'বাংলাদেশ পল্লী উন্নয়ন বোর্ড (বিআরডিবি)', '59', 59);
INSERT INTO `departments` VALUES (256, NULL, 'বাংলাদেশ পল্লী উন্নয়ন একাডেমি (বার্ড), কুমিল্লা', '59', 59);
INSERT INTO `departments` VALUES (257, NULL, 'পল্লী উন্নয়ন একাডেমি (আরডিএ) বগুড়া', '59', 59);
INSERT INTO `departments` VALUES (258, NULL, 'বঙ্গবন্ধু দারিদ্র্য বিমোচন ও পল্লী উন্নয়ন একাডেমি (বাপার্ড)', '59', 59);
INSERT INTO `departments` VALUES (259, NULL, 'বাংলাদেশ দুগ্ধ উৎপাদনকারী সমবায় ইউনিয়ন লিমিটেড (মিল্কভিটা)', '59', 59);
INSERT INTO `departments` VALUES (260, NULL, 'বাংলাদেশ সমবায় ব্যাংক লিমিটেড', '59', 59);
INSERT INTO `departments` VALUES (261, NULL, 'ক্ষুদ্র কৃষক উন্নয়ন ফাউন্ডেশন (এসএফডিএফ)', '59', 59);
INSERT INTO `departments` VALUES (262, NULL, 'পল্লী দারিদ্র্য বিমোচন ফাউন্ডেশন(পিডিবিএফ)', '59', 59);
INSERT INTO `departments` VALUES (263, NULL, 'বাংলাদেশ জাতীয় পল্লী উন্নয়ন সমবায় ফেডারেশন', '59', 59);
INSERT INTO `departments` VALUES (264, NULL, 'বাণিজ্য মন্ত্রণালয়', '21', 21);
INSERT INTO `departments` VALUES (265, NULL, 'বাংলাদেশ চা গবেষণা ইনস্টিটিউট', '21', 21);
INSERT INTO `departments` VALUES (266, NULL, 'বাংলাদেশ বৈদেশিক বাণিজ্য ইনস্টিটিউট', '21', 21);
INSERT INTO `departments` VALUES (267, NULL, 'জাতীয় ভোক্তা অধিকার সংরক্ষণ অধিদপ্তর', '21', 21);
INSERT INTO `departments` VALUES (268, NULL, 'বাংলাদেশ ট্যারিফ কমিশন', '21', 21);
INSERT INTO `departments` VALUES (269, NULL, 'আমদানি ও রপ্তানি নিয়ন্ত্রণ অধিদপ্তর', '21', 21);
INSERT INTO `departments` VALUES (270, NULL, 'ইনস্টিটিউট অব চার্টার্ড একাউন্ট্যান্টস অব বাংলাদেশ', '21', 21);
INSERT INTO `departments` VALUES (271, NULL, 'যৌথমূলধন কোম্পানি ও ফার্মসমূহের নিবন্ধকের কার্যালয়', '21', 21);
INSERT INTO `departments` VALUES (272, NULL, 'ইনস্টিটিউট অব কস্ট এন্ড ম্যানেজমেন্ট একাউন্ট্যান্টস', '21', 21);
INSERT INTO `departments` VALUES (273, NULL, 'ট্রেডিং কর্পোরেশন অব বাংলাদেশ (টিসিবি)', '21', 21);
INSERT INTO `departments` VALUES (274, NULL, 'বাংলাদেশ রপ্তানী উন্নয়ন ব্যুরো', '21', 21);
INSERT INTO `departments` VALUES (275, NULL, 'বাংলাদেশ চা বোর্ড', '21', 21);
INSERT INTO `departments` VALUES (276, NULL, 'সড়ক পরিবহন ও সেতু মন্ত্রণালয়', '46', 46);
INSERT INTO `departments` VALUES (277, NULL, 'সড়ক পরিবহন ও মহাসড়ক বিভাগ', '46', 46);
INSERT INTO `departments` VALUES (278, NULL, 'ঢাকা ম্যাস ট্রানজিট কোম্পানি লিমিটেড (ডিএমটিসিএল)', '46', 46);
INSERT INTO `departments` VALUES (279, NULL, 'ঢাকা পরিবহন সমন্বয় কর্তৃপক্ষ', '46', 46);
INSERT INTO `departments` VALUES (280, NULL, 'সড়ক ও জনপথ অধিদপ্তর', '46', 46);
INSERT INTO `departments` VALUES (281, NULL, 'বাংলাদেশ সড়ক পরিবহন কর্পোরেশন', '46', 46);
INSERT INTO `departments` VALUES (282, NULL, 'বাংলাদেশ সড়ক পরিবহন কর্তৃপক্ষ', '46', 46);
INSERT INTO `departments` VALUES (283, NULL, 'সেতু বিভাগ', '46', 46);
INSERT INTO `departments` VALUES (284, NULL, 'বাংলাদেশ সেতু কর্তৃপক্ষ', '46', 46);
INSERT INTO `departments` VALUES (285, NULL, 'সংস্কৃতি বিষয়ক মন্ত্রণালয়', '37', 37);
INSERT INTO `departments` VALUES (286, NULL, 'প্রত্নতত্ত্ব অধিদপ্তর', '37', 37);
INSERT INTO `departments` VALUES (287, NULL, 'বাংলাদেশ শিল্পকলা একাডেমি', '37', 37);
INSERT INTO `departments` VALUES (288, NULL, 'বাংলাদেশ লোক ও কারুশিল্প ফাউন্ডেশন', '37', 37);
INSERT INTO `departments` VALUES (289, NULL, 'বাংলা একাডেমী', '37', 37);
INSERT INTO `departments` VALUES (290, NULL, 'বাংলাদেশ জাতীয় জাদুঘর', '37', 37);
INSERT INTO `departments` VALUES (291, NULL, 'গণগ্রন্থাগার অধিদপ্তর', '37', 37);
INSERT INTO `departments` VALUES (292, NULL, 'বাংলাদেশ কপিরাইট অফিস', '37', 37);
INSERT INTO `departments` VALUES (293, NULL, 'আরকাইভস ও গ্রন্থাগার অধিদপ্তর', '37', 37);
INSERT INTO `departments` VALUES (294, NULL, 'প্রতিরক্ষা মন্ত্রণালয়', '18', 18);
INSERT INTO `departments` VALUES (295, NULL, 'বাংলাদেশ অর্ডন্যান্স ফ্যাক্টরিজ', '18', 18);
INSERT INTO `departments` VALUES (296, NULL, 'বাংলাদেশ আবহাওয়া অধিদপ্তর', '18', 18);
INSERT INTO `departments` VALUES (297, NULL, 'কন্ট্রোলার জেনারেল ডিফেন্স ফাইন্যান্স', '18', 18);
INSERT INTO `departments` VALUES (298, NULL, 'প্রতিরক্ষা ক্রয় মহা-পরিদপ্তর', '18', 18);
INSERT INTO `departments` VALUES (299, NULL, 'বাংলাদেশ মহাকাশ গবেষণা ও দূর অনুধাবন সংস্থা', '18', 18);
INSERT INTO `departments` VALUES (300, NULL, 'মিলিটারি ইনস্টিটিউট অব সায়েন্স এন্ড টেকনোলজি', '18', 18);
INSERT INTO `departments` VALUES (301, NULL, 'বাংলাদেশ জরিপ অধিদপ্তর', '18', 18);
INSERT INTO `departments` VALUES (302, NULL, 'সামরিক বাহিনী কমান্ড এন্ড স্টাফ কলেজ', '18', 18);
INSERT INTO `departments` VALUES (303, NULL, 'জাতীয় প্রতিরক্ষা কলেজ', '18', 18);
INSERT INTO `departments` VALUES (304, NULL, 'দুর্যোগ ব্যবস্থাপনা ও ত্রাণ মন্ত্রণালয়', '43', 43);
INSERT INTO `departments` VALUES (305, NULL, 'দুর্যোগ ব্যবস্থাপনা অধিদপ্তর', '43', 43);
INSERT INTO `departments` VALUES (306, NULL, 'ঘূর্ণিঝড় প্রস্তুতি কর্মসূচি (সিপিপি)', '43', 43);
INSERT INTO `departments` VALUES (307, NULL, 'পরিবেশ, বন ও জলবায়ু পরিবর্তন মন্ত্রণালয়', '17', 17);
INSERT INTO `departments` VALUES (308, NULL, 'বাংলাদেশ জলবায়ু পরিবর্তন ট্রাস্ট', '17', 17);
INSERT INTO `departments` VALUES (309, NULL, 'বন অধিদপ্তর', '17', 17);
INSERT INTO `departments` VALUES (310, NULL, 'পরিবেশ অধিদপ্তর', '17', 17);
INSERT INTO `departments` VALUES (311, NULL, 'বাংলাদেশ বন গবেষণা ইন্সটিটিউট (বি এফ আর আই)', '17', 17);
INSERT INTO `departments` VALUES (312, NULL, 'বাংলাদেশ বনশিল্প উন্নয়ন কর্পোরেশন', '17', 17);
INSERT INTO `departments` VALUES (313, NULL, 'বাংলাদেশ ন্যাশনাল হারবেরিয়াম', '17', 17);
INSERT INTO `departments` VALUES (314, NULL, 'প্রবাসী কল্যাণ ও বৈদেশিক কর্মসংস্থান মন্ত্রণালয়', '42', 42);
INSERT INTO `departments` VALUES (315, NULL, 'ওয়েজ আর্নার্স কল্যাণ বোর্ড', '42', 42);
INSERT INTO `departments` VALUES (316, NULL, 'প্রবাসী কল্যাণ ব্যাংক', '42', 42);
INSERT INTO `departments` VALUES (317, NULL, 'জনশক্তি কর্মসংস্থান ও প্রশিক্ষণ ব্যুরো', '42', 42);
INSERT INTO `departments` VALUES (318, NULL, 'বাংলাদেশ ওভারসিজ এমপ্লয়মেন্ট অ্যান্ড সার্ভিসেস লিঃ (বোয়েসেল)', '42', 42);
INSERT INTO `departments` VALUES (319, NULL, 'মৎস্য ও প্রাণিসম্পদ মন্ত্রণালয়', '27', 27);
INSERT INTO `departments` VALUES (320, NULL, 'বাংলাদেশ প্রাণিসম্পদ গবেষণা ইনস্টিটিউট (বিএলআরআই)', '27', 27);
INSERT INTO `departments` VALUES (321, NULL, 'মেরিন ফিসারিজ একাডেমি', '27', 27);
INSERT INTO `departments` VALUES (322, NULL, 'বাংলাদেশ মৎস্য উন্নয়ন কর্পোরেশন', '27', 27);
INSERT INTO `departments` VALUES (323, NULL, 'মৎস্য অধিদপ্তর', '27', 27);
INSERT INTO `departments` VALUES (324, NULL, 'বাংলাদেশ মৎস্য গবেষণা ইনস্টিটিউট', '27', 27);
INSERT INTO `departments` VALUES (325, NULL, 'প্রাণিসম্পদ অধিদপ্তর', '27', 27);
INSERT INTO `departments` VALUES (326, NULL, 'খাদ্য মন্ত্রণালয়', '9', 9);
INSERT INTO `departments` VALUES (327, NULL, 'খাদ্য অধিদপ্তর', '9', 9);
INSERT INTO `departments` VALUES (328, NULL, 'স্বরাষ্ট্র মন্ত্রণালয়', '38', 38);
INSERT INTO `departments` VALUES (329, NULL, 'জননিরাপত্তা বিভাগ', '38', 38);
INSERT INTO `departments` VALUES (330, NULL, 'আন্তর্জাতিক অপরাধ ট্রাইব্যুনাল', '38', 38);
INSERT INTO `departments` VALUES (332, NULL, 'বর্ডার গার্ড বাংলাদেশ', '38', 38);
INSERT INTO `departments` VALUES (333, NULL, 'বাংলাদেশ আনসার ও গ্রাম প্রতিরক্ষা বাহিনী', '38', 38);
INSERT INTO `departments` VALUES (334, NULL, 'বাংলাদেশ কোস্ট গার্ড', '38', 38);
INSERT INTO `departments` VALUES (336, NULL, 'বাংলাদেশ পুলিশ', '38', 38);
INSERT INTO `departments` VALUES (337, NULL, 'সুরক্ষা সেবা বিভাগ', '38', 38);
INSERT INTO `departments` VALUES (338, NULL, 'মাদকদ্রব্য নিয়ন্ত্রণ অধিদপ্তর', '38', 38);
INSERT INTO `departments` VALUES (339, NULL, 'কারা অধিদপ্তর', '38', 38);
INSERT INTO `departments` VALUES (340, NULL, 'বহিরাগমন ও পাসপোর্ট অধিদপ্তর', '38', 38);
INSERT INTO `departments` VALUES (341, NULL, 'বাংলাদেশ ফায়ার সার্ভিস ও সিভিল ডিফেন্স অধিদপ্তর', '38', 38);
INSERT INTO `departments` VALUES (342, NULL, 'শিল্প মন্ত্রণালয়', '30', 30);
INSERT INTO `departments` VALUES (343, NULL, 'চিটাগাং ড্রাই ডক লিমিটেড', '30', 30);
INSERT INTO `departments` VALUES (344, NULL, 'পেটেন্ট, ডিজাইন ও ট্রেডমার্কস অধিদপ্তর', '30', 30);
INSERT INTO `departments` VALUES (345, NULL, 'ডিএপি ফার্টিলাইজার কোম্পানী লিমিটেড (ডিএপিএফসিএল)', '30', 30);
INSERT INTO `departments` VALUES (346, NULL, 'স্মল এন্ড মিডিয়াম এন্টারপ্রাইজ ফাউন্ডেশন (এসএমইএফ)', '30', 30);
INSERT INTO `departments` VALUES (347, NULL, 'বাংলাদেশ এ্যাক্রেডিটেশন বোর্ড', '30', 30);
INSERT INTO `departments` VALUES (348, NULL, 'প্রধান বয়লার পরিদর্শকের কার্যালয়', '30', 30);
INSERT INTO `departments` VALUES (349, NULL, 'বাংলাদেশ কেমিক্যাল ইন্ডাস্ট্রিজ কর্পোরেশন', '30', 30);
INSERT INTO `departments` VALUES (350, NULL, 'বাংলাদেশ ইস্পাত ও প্রকৌশল কর্পোরেশন', '30', 30);
INSERT INTO `departments` VALUES (351, NULL, 'বাংলাদেশ ক্ষুদ্র ও কুটির শিল্প করপোরেশন', '30', 30);
INSERT INTO `departments` VALUES (352, NULL, 'বাংলাদেশ ইনস্টিটিউট অব ম্যানেজমেন্ট', '30', 30);
INSERT INTO `departments` VALUES (353, NULL, 'বাংলাদেশ স্ট্যান্ডার্ডস এন্ড টেস্টিং ইন্সটিটিউশন', '30', 30);
INSERT INTO `departments` VALUES (354, NULL, 'বাংলাদেশ শিল্প কারিগরি সহায়তা কেন্দ্র (বিটাক)', '30', 30);
INSERT INTO `departments` VALUES (355, NULL, 'ন্যাশনাল প্রোডাকটিভিটি অর্গানাইজেশন (এনপিও)', '30', 30);
INSERT INTO `departments` VALUES (356, NULL, 'বাংলাদেশ চিনি ও খাদ্য শিল্প করপোরেশন', '30', 30);
INSERT INTO `departments` VALUES (357, NULL, 'শ্রম ও কর্মসংস্থান মন্ত্রণালয়', '34', 34);
INSERT INTO `departments` VALUES (358, NULL, 'কলকারখানা ও প্রতিষ্ঠান পরিদর্শন অধিদপ্তর', '34', 34);
INSERT INTO `departments` VALUES (359, NULL, 'শ্রম অধিদপ্তর', '34', 34);
INSERT INTO `departments` VALUES (360, NULL, 'শ্রম আপীল ট্রাইব্যুনাল', '34', 34);
INSERT INTO `departments` VALUES (361, NULL, 'নিম্নতম মজুরি বোর্ড', '34', 34);
INSERT INTO `departments` VALUES (362, NULL, 'জাতীয় দক্ষতা উন্নয়ন কাউন্সিল', '34', 34);
INSERT INTO `departments` VALUES (363, NULL, 'বাংলাদেশ শ্রমিক কল্যাণ ফাউন্ডেশন', '34', 34);
INSERT INTO `departments` VALUES (364, NULL, 'চাইল্ড লেবার ইউনিট', '34', 34);
INSERT INTO `departments` VALUES (365, NULL, 'মুক্তিযুদ্ধ বিষয়ক মন্ত্রণালয়', '41', 41);
INSERT INTO `departments` VALUES (366, NULL, 'জাতীয় মুক্তিযোদ্ধা পরিষদ (জামুকা)', '41', 41);
INSERT INTO `departments` VALUES (367, NULL, 'বাংলাদেশ মুক্তিযোদ্ধা কল্যান ট্রাস্ট', '41', 41);
INSERT INTO `departments` VALUES (368, NULL, 'ডাক, টেলিযোগাযোগ ও তথ্যপ্রযুক্তি মন্ত্রণালয়', '368', 368);
INSERT INTO `departments` VALUES (369, NULL, 'ডাক ও টেলিযোগাযোগ বিভাগ', '10', 10);
INSERT INTO `departments` VALUES (370, NULL, 'বাংলাদেশ টেলিকমিউনিকেশনস কোম্পানি লিমিটেড', '10', 10);
INSERT INTO `departments` VALUES (371, NULL, 'বাংলাদেশ টেলিকমিউনিকেশনস রেগুলেটারি কমিশন', '10', 10);
INSERT INTO `departments` VALUES (372, NULL, 'ডাক অধিদপ্তর, বাংলাদেশ ডাক বিভাগ', '10', 10);
INSERT INTO `departments` VALUES (373, NULL, 'বাংলাদেশ ক্যাবল শিল্প লিমিটেড', '10', 10);
INSERT INTO `departments` VALUES (374, NULL, 'টেলিফোন শিল্প সংস্থা লিঃ', '10', 10);
INSERT INTO `departments` VALUES (375, NULL, 'বাংলাদেশ সাবমেরিন ক্যাবল কোম্পানি', '10', 10);
INSERT INTO `departments` VALUES (376, NULL, 'টেলিটক বাংলাদেশ', '10', 10);
INSERT INTO `departments` VALUES (377, NULL, 'টেলিযোগাযোগ অধিদপ্তর', '10', 10);
INSERT INTO `departments` VALUES (378, NULL, 'তথ্য ও যোগাযোগ প্রযুক্তি বিভাগ', '49', 49);
INSERT INTO `departments` VALUES (379, NULL, 'তথ্য ও যোগাযোগ প্রযুক্তি অধিদপ্তর', '49', 49);
INSERT INTO `departments` VALUES (380, NULL, 'বাংলাদেশ কম্পিউটার কাউন্সিল (বিসিসি)', '49', 49);
INSERT INTO `departments` VALUES (381, NULL, 'কন্ট্রোলার অব সার্টিফাইং অথরিটিজ', '49', 49);
INSERT INTO `departments` VALUES (382, NULL, 'বাংলাদেশ হাই-টেক পার্ক কর্তৃপক্ষ', '49', 49);
INSERT INTO `departments` VALUES (383, NULL, 'একসেস টু ইনফরমেশন (এটুআই) প্রকল্প', '49', 49);
INSERT INTO `departments` VALUES (384, NULL, 'ধর্ম বিষয়ক মন্ত্রণালয়', '12', 12);
INSERT INTO `departments` VALUES (385, NULL, 'বৌদ্ধ ধর্মীয় কল্যাণ ট্রাস্ট', '12', 12);
INSERT INTO `departments` VALUES (386, NULL, 'ইসলামিক ফাউন্ডেশন', '12', 12);
INSERT INTO `departments` VALUES (387, NULL, 'বাংলাদেশ হজ্জ্ব অফিস', '12', 12);
INSERT INTO `departments` VALUES (388, NULL, 'ওয়াকফ প্রশাসক', '12', 12);
INSERT INTO `departments` VALUES (389, NULL, 'খ্রিস্টান ধর্মীয় কল্যাণ ট্রাস্ট', '12', 12);
INSERT INTO `departments` VALUES (390, NULL, 'হিন্দু ধর্মীয় কল্যাণ ট্রাস্ট', '12', 12);
INSERT INTO `departments` VALUES (391, NULL, 'প্রাথমিক ও গণশিক্ষা মন্ত্রণালয়', '32', 32);
INSERT INTO `departments` VALUES (392, NULL, 'প্রাথমিক শিক্ষা অধিদপ্তর', '32', 32);
INSERT INTO `departments` VALUES (393, NULL, 'উপানুষ্ঠানিক শিক্ষা ব্যুরো', '32', 32);
INSERT INTO `departments` VALUES (394, NULL, 'জাতীয় প্রাথমিক শিক্ষা একাডেমি', '32', 32);
INSERT INTO `departments` VALUES (395, NULL, 'রেলপথ মন্ত্রণালয়', '44', 44);
INSERT INTO `departments` VALUES (396, NULL, 'বাংলাদেশ রেলওয়ে', '44', 44);
INSERT INTO `departments` VALUES (397, NULL, 'নৌ-পরিবহন মন্ত্রণালয়', '14', 14);
INSERT INTO `departments` VALUES (398, NULL, 'জাতীয় নদী রক্ষা কমিশন', '14', 14);
INSERT INTO `departments` VALUES (399, NULL, 'বাংলাদেশ স্থল বন্দর কর্তৃপক্ষ', '14', 14);
INSERT INTO `departments` VALUES (400, NULL, 'বাংলাদেশ মেরিন একাডেমী', '14', 14);
INSERT INTO `departments` VALUES (401, NULL, 'বাংলাদেশ অভ্যন্তরীণ নৌ-পরিবহন কর্তৃপক্ষ', '14', 14);
INSERT INTO `departments` VALUES (402, NULL, 'বাংলাদেশ অভ্যন্তরীণ নৌ-পরিবহন কর্পোরেশন', '14', 14);
INSERT INTO `departments` VALUES (403, NULL, 'শিপিং অধিদপ্তর', '14', 14);
INSERT INTO `departments` VALUES (404, NULL, 'চট্টগ্রাম বন্দর কর্তৃপক্ষ', '14', 14);
INSERT INTO `departments` VALUES (405, NULL, 'মংলা বন্দর কর্তৃপক্ষ', '14', 14);
INSERT INTO `departments` VALUES (406, NULL, 'ন্যাশনাল মেরিটাইম ইনস্টিটিউট', '14', 14);
INSERT INTO `departments` VALUES (407, NULL, 'বিজ্ঞান ও প্রযুক্তি মন্ত্রণালয়', '33', 33);
INSERT INTO `departments` VALUES (408, NULL, 'বাংলাদেশ পরমাণু শক্তি কমিশন', '33', 33);
INSERT INTO `departments` VALUES (409, NULL, 'বাংলাদেশ বিজ্ঞান ও শিল্প গবেষণা পরিষদ (বিসিএসআইআর)', '33', 33);
INSERT INTO `departments` VALUES (410, NULL, 'জাতীয় বিজ্ঞান ও প্রযুক্তি জাদুঘর', '33', 33);
INSERT INTO `departments` VALUES (411, NULL, 'ন্যাশনাল ইনস্টিটিউট অব বায়োটেকনোলজি', '33', 33);
INSERT INTO `departments` VALUES (412, NULL, 'বঙ্গবন্ধু শেখ মুজিবুর রহমান নভো থিয়েটার', '33', 33);
INSERT INTO `departments` VALUES (413, NULL, 'বাংলাদেশ ন্যাশনাল সায়েন্টিফিক এন্ড টেকনিক্যাল ডকুমেন্টশন সেন্টার', '33', 33);
INSERT INTO `departments` VALUES (414, NULL, 'বাংলাদেশ পরমাণু শক্তি নিয়ন্ত্রণ কর্তৃপক্ষ', '33', 33);
INSERT INTO `departments` VALUES (415, NULL, 'বাংলাদেশ ওশানোগ্রাফিক রিসার্চ ইনস্টিটিউট', '33', 33);
INSERT INTO `departments` VALUES (416, NULL, 'রূপপুর পারমাণবিক বিদ্যুৎ কেন্দ্র নির্মাণ প্রকল্প', '33', 33);
INSERT INTO `departments` VALUES (417, NULL, 'বঙ্গবন্ধু বিজ্ঞান ও প্রযুক্তি ফেলোশিপ ট্রাস্ট', '33', 33);
INSERT INTO `departments` VALUES (418, NULL, 'পানি সম্পদ মন্ত্রণালয়', '418', 418);
INSERT INTO `departments` VALUES (419, NULL, 'সেন্টার ফর এনভায়রনমেন্টাল এন্ড জিওগ্রাফিক ইনফরমেশন সার্ভিসেস', '418', 418);
INSERT INTO `departments` VALUES (420, NULL, 'ইনস্টিটিউট অব ওয়াটার মডেলিং', '418', 418);
INSERT INTO `departments` VALUES (421, NULL, 'পানি সম্পদ পরিকল্পনা সংস্থা (ওয়ারপো)', '418', 418);
INSERT INTO `departments` VALUES (422, NULL, 'বাংলাদেশ পানি উন্নয়ন বোর্ড', '418', 418);
INSERT INTO `departments` VALUES (423, NULL, 'যৌথ নদী কমিশন, বাংলাদেশ', '418', 418);
INSERT INTO `departments` VALUES (424, NULL, 'বন্যার পূর্বাভাস ও সতর্কীকরণ কেন্দ্র', '418', 418);
INSERT INTO `departments` VALUES (425, NULL, 'যুব ও ক্রীড়া মন্ত্রণালয়', '425', 425);
INSERT INTO `departments` VALUES (426, NULL, 'বাংলাদেশ ক্রীড়া শিক্ষা প্রতিষ্ঠান', '425', 425);
INSERT INTO `departments` VALUES (427, NULL, 'যুব উন্নয়ন অধিদপ্তর', '425', 425);
INSERT INTO `departments` VALUES (428, NULL, 'ক্রীড়া পরিদপ্তর', '425', 425);
INSERT INTO `departments` VALUES (429, NULL, 'জাতীয় ক্রীড়া পরিষদ', '425', 425);
INSERT INTO `departments` VALUES (430, NULL, 'তথ্য মন্ত্রণালয়', '11', 11);
INSERT INTO `departments` VALUES (431, NULL, 'বাংলাদেশ চলচ্চিত্র ও টেলিভিশন ইন্সটিটিউট', '11', 11);
INSERT INTO `departments` VALUES (432, NULL, 'বাংলাদেশ প্রেস কাউন্সিল', '11', 11);
INSERT INTO `departments` VALUES (433, NULL, 'বাংলাদেশ প্রেস ইনস্টিটিউট (পিআইবি)', '11', 11);
INSERT INTO `departments` VALUES (434, NULL, 'জাতীয় গণমাধ্যম ইনস্টিটিউট', '11', 11);
INSERT INTO `departments` VALUES (435, NULL, 'তথ্য অধিদফতর (পিআইডি)', '11', 11);
INSERT INTO `departments` VALUES (436, NULL, 'গণযোগাযোগ অধিদপ্তর', '11', 11);
INSERT INTO `departments` VALUES (437, NULL, 'বাংলাদেশ চলচ্চিত্র উন্নয়ন কর্পোরেশন', '11', 11);
INSERT INTO `departments` VALUES (438, NULL, 'বাংলাদেশ ফিল্ম আর্কাইভ', '11', 11);
INSERT INTO `departments` VALUES (439, NULL, 'বাংলাদেশ সংবাদ সংস্থা', '11', 11);
INSERT INTO `departments` VALUES (440, NULL, 'বাংলাদেশ টেলিভিশন', '11', 11);
INSERT INTO `departments` VALUES (441, NULL, 'বাংলাদেশ চলচ্চিত্র সেন্সর বোর্ড', '11', 11);
INSERT INTO `departments` VALUES (442, NULL, 'বাংলাদেশ বেতার', '11', 11);
INSERT INTO `departments` VALUES (443, NULL, 'বাংলাদেশ চলচ্চিত্র ও প্রকাশনা অধিদপ্তর', '11', 11);
INSERT INTO `departments` VALUES (444, NULL, 'রাষ্ট্রপতির কার্যালয়', '1', 1);
INSERT INTO `departments` VALUES (445, NULL, 'অর্থ মন্ত্রণালয়', '445', 445);
INSERT INTO `departments` VALUES (446, NULL, 'অভ্যন্তরীণ সম্পদ বিভাগ', '445', 446);
INSERT INTO `departments` VALUES (447, NULL, 'জাতীয় রাজস্ব বোর্ড', '445', 446);
INSERT INTO `departments` VALUES (448, NULL, 'জাতীয় সঞ্চয় অধিদপ্তর', '445', 446);
INSERT INTO `departments` VALUES (449, NULL, 'বাংলাদেশ কাস্টমস, এক্সাইজ এবং ভ্যাট আপীলাত ট্রাইব্যুনাল', '445', 446);
INSERT INTO `departments` VALUES (450, NULL, 'ট্যাকসেস আপীলাত ট্রাইবুনাল', '445', 446);
INSERT INTO `departments` VALUES (451, NULL, 'অর্থনৈতিক সম্পর্ক বিভাগ', '445', 451);
INSERT INTO `departments` VALUES (452, NULL, 'অর্থ বিভাগ', '6', 6);
INSERT INTO `departments` VALUES (453, NULL, 'বাংলাদেশ হাউস বিল্ডিং ফাইন্যান্স কর্পোরেশন', '6', 6);
INSERT INTO `departments` VALUES (454, NULL, 'ইনভেস্টমেন্ট কর্পোরেশন অব বাংলাদেশ', '6', 6);
INSERT INTO `departments` VALUES (455, NULL, 'অফিস অফ দি কন্ট্রোলার জেনারেল অফ একাউন্টস', '6', 6);
INSERT INTO `departments` VALUES (456, NULL, 'বাংলাদেশ কম্পট্রোলার এন্ড অডিটর জেনারেল', '6', 6);
INSERT INTO `departments` VALUES (457, NULL, 'আর্থিক প্রতিষ্ঠান বিভাগ', '6', 6);
INSERT INTO `departments` VALUES (458, NULL, 'বাংলাদেশ সিকিউরিটিজ ও এক্সচেঞ্জ কমিশন', '6', 6);
INSERT INTO `departments` VALUES (459, NULL, 'সোনালী ব্যাংক লিমিটেড', '6', 6);
INSERT INTO `departments` VALUES (460, NULL, 'অগ্রণী ব্যাংক লিমিটেড', '6', 6);
INSERT INTO `departments` VALUES (461, NULL, 'রূপালী ব্যাংক লিমিটেড', '6', 6);
INSERT INTO `departments` VALUES (462, NULL, 'জনতা ব্যাংক লিমিটেড', '6', 6);
INSERT INTO `departments` VALUES (463, NULL, 'রাজশাহী কৃষি উন্নয়ন ব্যাংক', '6', 6);
INSERT INTO `departments` VALUES (464, NULL, 'সাধারন বীমা কর্পোরেশন', '6', 6);
INSERT INTO `departments` VALUES (465, NULL, 'জীবন বীমা কর্পোরেশন', '6', 6);
INSERT INTO `departments` VALUES (466, NULL, 'বাংলাদেশ ইনস্টিটিউট অব ক্যাপিটাল মার্কেট', '6', 6);
INSERT INTO `departments` VALUES (467, NULL, 'বাংলাদেশ কৃষি ব্যাংক', '6', 6);
INSERT INTO `departments` VALUES (468, NULL, 'বাংলাদেশ ইনস্টিটিউট অব ব্যাংক ম্যানেজমেন্ট', '6', 6);
INSERT INTO `departments` VALUES (469, NULL, 'দি সিকিউরিটি প্রিন্টিং করপোরেশন (বাংলাদেশ) লিঃ', '6', 6);
INSERT INTO `departments` VALUES (470, NULL, 'পল্লী কর্ম-সহায়ক ফাউন্ডেশন (পিকেএসএফ)', '6', 6);
INSERT INTO `departments` VALUES (471, NULL, 'চট্টগ্রাম স্টক এক্সচেঞ্জ', '6', 6);
INSERT INTO `departments` VALUES (472, NULL, 'ঢাকা স্টক এক্সচেঞ্জ', '6', 6);
INSERT INTO `departments` VALUES (473, NULL, 'বাংলাদেশ ব্যাংক', '6', 6);
INSERT INTO `departments` VALUES (474, NULL, 'মাইক্রোক্রেডিট রেগুলেটরী অথরিটি', '6', 6);
INSERT INTO `departments` VALUES (475, NULL, 'বীমা উন্নয়ন ও নিয়ন্ত্রণ কর্তৃপক্ষ বাংলাদেশ', '6', 6);
INSERT INTO `departments` VALUES (476, NULL, 'বাংলাদেশ সুপ্রিম কোর্ট', '45', 45);
INSERT INTO `departments` VALUES (477, NULL, 'হাইকোর্ট বিভাগ', '45', 45);
INSERT INTO `departments` VALUES (478, NULL, 'জেলা জজ কোর্ট', '45', 45);
INSERT INTO `departments` VALUES (479, NULL, 'অতিরিক্ত জেলা জজ কোর্ট', '45', 45);
INSERT INTO `departments` VALUES (480, NULL, 'চীফ জুডিসিয়াল ম্যাজিস্ট্রেট কোর্ট', '45', 45);
INSERT INTO `departments` VALUES (481, NULL, 'সংসদ সচিবালয়', '47', 47);
INSERT INTO `departments` VALUES (482, NULL, 'নির্বাচন কমিশন সচিবালয়', '13', 13);
INSERT INTO `departments` VALUES (483, NULL, 'আপীল বিভাগ', '476', 476);
INSERT INTO `departments` VALUES (484, NULL, 'তথ্য কমিশন', '11', 11);
...
-- Records of groups
-- ----------------------------
INSERT INTO `groups` VALUES (1, 'admin', 'Administrator', 'a:24:{i:0;s:12:\"createMember\";i:1;s:12:\"updateMember\";i:2;s:10:\"viewMember\";i:3;s:12:\"deleteMember\";i:4;s:11:\"createGroup\";i:5;s:11:\"updateGroup\";i:6;s:9:\"viewGroup\";i:7;s:11:\"deleteGroup\";i:8;s:10:\"createUser\";i:9;s:10:\"updateUser\";i:10;s:8:\"viewUser\";i:11;s:10:\"deleteUser\";i:12;s:14:\"createLocation\";i:13;s:14:\"updateLocation\";i:14;s:12:\"viewLocation\";i:15;s:14:\"deleteLocation\";i:16;s:17:\"createBeneficiary\";i:17;s:17:\"updateBeneficiary\";i:18;s:15:\"viewBeneficiary\";i:19;s:17:\"deleteBeneficiary\";i:20;s:13:\"createSeweing\";i:21;s:13:\"updateSeweing\";i:22;s:11:\"viewSeweing\";i:23;s:13:\"deleteSeweing\";}');
INSERT INTO `groups` VALUES (2, 'member', 'member', 'a:4:{i:0;s:17:\"createBeneficiary\";i:1;s:17:\"updateBeneficiary\";i:2;s:15:\"viewBeneficiary\";i:3;s:17:\"deleteBeneficiary\";}');
...
CREATE TABLE `members`  (
  ...
  `dob` date NOT NULL,
  `nid` int(17) NOT NULL,
  `highest_education` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `academic_subject_graduation` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `first_joining_designation_id` int(10) NULL DEFAULT NULL,
  `first_joining_designation_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `first_joining_date` date NULL DEFAULT NULL,
  `first_joining_payscale_id` int(10) NULL DEFAULT NULL,
  `first_joining_payscale_name` int(10) NULL DEFAULT NULL,
  `first_joining_ministry_id` int(10) NULL DEFAULT NULL,
  `first_joining_ministry_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `first_joining_department_id` int(10) NULL DEFAULT NULL,
  `first_joining_department_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `first_joining_office_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `current_psc_advertisement_date` date NULL DEFAULT NULL,
  `current_psc_merit_list` int(10) NULL DEFAULT NULL,
  `current_appointment_type_id` int(10) NULL DEFAULT NULL,
  `current_designation_id` int(10) NULL DEFAULT NULL,
  `current_designation_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `current_ministry_id` int(10) NULL DEFAULT NULL,
  `current_ministry_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `current_department_id` int(10) NULL DEFAULT NULL,
  `current_department_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `current_office_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `current_payscale_id` int(10) NOT NULL,
  `current_payscale_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `current_join_date` date NULL DEFAULT NULL,
  `forum_membership_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `ieb_membership_no` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `bcs_membership_no` varbinary(50) NULL DEFAULT NULL,
  `primary_email` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `secondary_email` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `mobile_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `office_contact_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `home_contact_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `present_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `permanent_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `spouse_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `spouse_profession` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `number_of_children` int(10) NULL DEFAULT NULL,
  `hobby` varchar(500) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `website_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `fb_link` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `linkedin_link` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `office_web_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `personal_web_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `valid_voter` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `life_member` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `image` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `created_at` datetime(0) NULL DEFAULT NULL,
  `created_by` int(11) NULL DEFAULT NULL,
  `updated_at` datetime(0) NULL DEFAULT NULL,
  `updated_by` int(11) NULL DEFAULT NULL,
  `membership_status` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for membership_status
-- ----------------------------
...
-- ----------------------------
-- Records of membership_status
-- ----------------------------
INSERT INTO `membership_status` VALUES (1, 'Pending');
INSERT INTO `membership_status` VALUES (2, 'Member');
INSERT INTO `membership_status` VALUES (3, 'Life Member');
INSERT INTO `membership_status` VALUES (4, 'Expired');
INSERT INTO `membership_status` VALUES (6, 'Rejected');

-- ----------------------------
-- Table structure for seweings
-- ----------------------------
DROP TABLE IF EXISTS `seweings`;
CREATE TABLE `seweings`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `father_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
  `mother_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '127.0.0.1', NULL, '$2y$12$hrZwxV6VW7TTghlJ1Uxs2udlrdVmp2aoYK5BcoPS0w1CV/3BT2Wdq', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1646203386, 1, 320);
...
INSERT INTO `users_groups` VALUES (475, 396, 1);
